...
// debug trait required by tokio
#[derive(Debug)]

// basic enum for getting data from the cycler (?)
enum Message {
    GetLatest {
...
// struct that contains the cycler data
...
impl ImageBuffer {
    ...
    #[allow(dead_code)]
    // function never used but kept regardless?
    // possibly a requirement by seperate crate?
